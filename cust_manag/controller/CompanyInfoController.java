...
public class CompanyInfoController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(
                    responseCode = "404",
                    description = "Company not found with the given SAP ID",
                    content = @Content(schema = @Schema(implementation = Map.class))
            ),
            @ApiResponse(
                    responseCode = "500",
    ...
    @Operation(
            ...
            description = "Search for companies by company name (case-insensitive partial match)"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<List<CompanyInfoResponseDTO>> searchCompaniesByName(
            @Parameter(description = "Company name (partial match, case-insensitive)", required = true, example = "Tech")
